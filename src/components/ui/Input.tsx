...
export const Input = ({ placeholder, password, icon, value, onChange, filled, searchIcon, onEnter }: Props) => {
	...
	return (
		...
		${filled && 'bg-gray-200 text-gray-900'}`}>
			...
			{icon && (
				<div className="p-3 bg-purple-primary rounded-md h-full flex items-center justify-center ">
					{icon}
				</div>
			)}
			...
			<input className="flex-1 outline-none bg-transparent h-full p-2 has-[:focus]:bg-gray-400"
