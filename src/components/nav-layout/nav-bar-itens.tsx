...
export const NavBarItens = () => {
	...
	return (
		<div className="flex relative mr-1">
			...
			<button
				onClick={handleClick}
				className="self-start absolute bg-white mt-11 mr-2 -right-6 p-1 rounded border-r border-l-0 border-gray-200 ease-in-out"
			>
				<ChevronDoubleLeftIcon
					className={`w-4 h-4 text-gray-500 transform transition-transform duration-500 ease-in-out ${collapsed ? 'rotate-180' : 'rotate-0'
						}`}
				/>
			</button>
